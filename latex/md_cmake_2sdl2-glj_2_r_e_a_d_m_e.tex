\chapter{SDL2 CMake modules}
\hypertarget{md_cmake_2sdl2-glj_2_r_e_a_d_m_e}{}\label{md_cmake_2sdl2-glj_2_r_e_a_d_m_e}\index{SDL2 CMake modules@{SDL2 CMake modules}}
\label{md_cmake_2sdl2-glj_2_r_e_a_d_m_e_autotoc_md437}%
\Hypertarget{md_cmake_2sdl2-glj_2_r_e_a_d_m_e_autotoc_md437}%
 {\bfseries{Updated\+:}} -\/ GLJ 27-\/2-\/2020
\begin{DoxyItemize}
\item The original version doesn\textquotesingle{}t work on Windows, taking out one of the changes (related to Threads) to see if this is the issue. It certainlty seems there is something SDL2 related going on.
\end{DoxyItemize}

{\bfseries{TODO}}
\begin{DoxyItemize}
\item This version uses the machine type to find the correct SDL2.\+dll version to link against (x86/x64) would be better to get this from the build system as there is we might want to compile for x86 on a x64 system.
\end{DoxyItemize}\hypertarget{md_cmake_2sdl2-glj_2_r_e_a_d_m_e_autotoc_md438}{}\doxysection{\texorpdfstring{ORIGINAL README FOLLOWS}{ORIGINAL README FOLLOWS}}\label{md_cmake_2sdl2-glj_2_r_e_a_d_m_e_autotoc_md438}
...
These modules are based on the SDL (1.\+2) modules, with the same names, distributed with the CMake project. The SDL2\+\_\+gfx module is also based on the SDL\+\_\+image module.\hypertarget{md_cmake_2sdl2-glj_2_r_e_a_d_m_e_autotoc_md439}{}\doxysubsection{\texorpdfstring{Details and Improvements}{Details and Improvements}}\label{md_cmake_2sdl2-glj_2_r_e_a_d_m_e_autotoc_md439}
...
{\itshape For more details, please see the embedded documentation in {\ttfamily Find\+SDL2\+\_\+\texorpdfstring{$<$}{<}COMPONENT\texorpdfstring{$>$}{>}.cmake} file.}\hypertarget{md_cmake_2sdl2-glj_2_r_e_a_d_m_e_autotoc_md440}{}\doxysubsection{\texorpdfstring{Usage}{Usage}}\label{md_cmake_2sdl2-glj_2_r_e_a_d_m_e_autotoc_md440}
...
Finally, we can use the SDL2 modules. There is two approaches that can be adopted\+: A legacy approach and a modern approach. Both of them are supported.\hypertarget{md_cmake_2sdl2-glj_2_r_e_a_d_m_e_autotoc_md441}{}\doxysubsubsection{\texorpdfstring{Modern CMake}{Modern CMake}}\label{md_cmake_2sdl2-glj_2_r_e_a_d_m_e_autotoc_md441}
...
{\itshape Use the appropriate packages for you project.}~\newline
 ...
 {\itshape For more details, please see the embedded documentation in modules files}\hypertarget{md_cmake_2sdl2-glj_2_r_e_a_d_m_e_autotoc_md442}{}\doxysubsubsection{\texorpdfstring{Legacy CMake}{Legacy CMake}}\label{md_cmake_2sdl2-glj_2_r_e_a_d_m_e_autotoc_md442}
...
{\itshape For more details, please see the embedded documentation in modules files}\hypertarget{md_cmake_2sdl2-glj_2_r_e_a_d_m_e_autotoc_md443}{}\doxysubsection{\texorpdfstring{Special customization variables}{Special customization variables}}\label{md_cmake_2sdl2-glj_2_r_e_a_d_m_e_autotoc_md443}
...
\end{DoxyCode}
\hypertarget{md_cmake_2sdl2-glj_2_r_e_a_d_m_e_autotoc_md444}{}\doxysubsection{\texorpdfstring{License}{License}}\label{md_cmake_2sdl2-glj_2_r_e_a_d_m_e_autotoc_md444}
