...
The parameter \texorpdfstring{$\ast$}{*}{\ttfamily sequences...}\texorpdfstring{$\ast$}{*} is any number of \doxysectlink{md_build_2__deps_2googletest-src_2docs_2reference_2mocking_Sequence}{\`{}\+Sequence\`{}}{2} objects. Expected calls assigned to the same sequence are expected to occur in the order the expectations are declared.
...
The parameter \texorpdfstring{$\ast$}{*}{\ttfamily action}\texorpdfstring{$\ast$}{*} represents the \href{../gmock_for_dummies.md\#actions-what-should-it-do}{\texttt{ action}} that the function call will perform. See the \doxysectlink{md_build_2__deps_2googletest-src_2docs_2reference_2actions}{Actions Reference}{0} for a list of built-\/in actions.
...
\doxylink{class_mock}{Mock} objects of type {\ttfamily T} by default behave the same way as {\ttfamily Naggy\+Mock\texorpdfstring{$<$}{<}T\texorpdfstring{$>$}{>}}.\hypertarget{md_build_2__deps_2googletest-src_2docs_2reference_2mocking_StrictMock}{}\doxysubsection{\texorpdfstring{Strict\+Mock}{Strict\+Mock}}\label{md_build_2__deps_2googletest-src_2docs_2reference_2mocking_StrictMock}
