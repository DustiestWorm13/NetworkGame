...
\label{md_build_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md117}%
\Hypertarget{md_build_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md117}%
...
\{\+: .callout .note\} {\bfseries{Note\+:}} g\+Mock lives in the {\ttfamily testing} name space. For readability, it is recommended to write {\ttfamily using \+::testing\+::\+Foo;} once in your file before using the name {\ttfamily Foo} defined by g\+Mock. We omit such {\ttfamily using} statements in this section for brevity, but you should do it in your own code.\hypertarget{md_build_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md118}{}\doxysection{\texorpdfstring{Creating Mock Classes}{Creating Mock Classes}}\label{md_build_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md118}
...
\end{DoxyItemize}\hypertarget{md_build_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md119}{}\doxysubsection{\texorpdfstring{Dealing with unprotected commas}{Dealing with unprotected commas}}\label{md_build_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md119}
...
\end{DoxyCode}
\hypertarget{md_build_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md120}{}\doxysubsection{\texorpdfstring{Mocking Private or Protected Methods}{Mocking Private or Protected Methods}}\label{md_build_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md120}
...
\end{DoxyCode}
\hypertarget{md_build_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md121}{}\doxysubsection{\texorpdfstring{Mocking Overloaded Methods}{Mocking Overloaded Methods}}\label{md_build_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md121}
...
\end{DoxyCode}
\hypertarget{md_build_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md122}{}\doxysubsection{\texorpdfstring{Mocking Class Templates}{Mocking Class Templates}}\label{md_build_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md122}
...
\end{DoxyCode}
\hypertarget{md_build_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md123}{}\doxysubsection{\texorpdfstring{Mocking Free Functions}{Mocking Free Functions}}\label{md_build_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md123}
...
If a mock method has no {\ttfamily EXPECT\+\_\+\+CALL} spec but is called, we say that it\textquotesingle{}s an "{}uninteresting call"{}, and the default action (which can be specified using {\ttfamily ON\+\_\+\+CALL()}) of the method will be taken. Currently, an uninteresting call will also by default cause g\+Mock to print a warning. (In the future, we might remove this warning by default.)
...
\end{DoxyCode}
\hypertarget{md_build_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md125}{}\doxysubsection{\texorpdfstring{Alternative to Mocking Concrete Classes}{Alternative to Mocking Concrete Classes}}\label{md_build_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md125}
...
(Why don\textquotesingle{}t we just write {\ttfamily \{ return foo.\+Concrete(str); \}}? If you do that, {\ttfamily Mock\+Foo\+::\+Concrete()} will be called (and cause an infinite recursion) since {\ttfamily Foo\+::\+Concrete()} is virtual. That\textquotesingle{}s just how C++ works.)\hypertarget{md_build_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md128}{}\doxysection{\texorpdfstring{Using Matchers}{Using Matchers}}\label{md_build_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md128}
\hypertarget{md_build_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md129}{}\doxysubsection{\texorpdfstring{Matching Argument Values Exactly}{Matching Argument Values Exactly}}\label{md_build_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md129}
...
\end{DoxyCode}
\hypertarget{md_build_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md130}{}\doxysubsection{\texorpdfstring{Using Simple Matchers}{Using Simple Matchers}}\label{md_build_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md130}
...
\end{DoxyCode}
\hypertarget{md_build_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md131}{}\doxysubsection{\texorpdfstring{Performing Different Actions Based on the Arguments}{Performing Different Actions Based on the Arguments}}\label{md_build_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md131}
...
Now, if {\ttfamily foo.\+Do\+This()} is called with a value less than 5, `\textquotesingle{}a'{\ttfamily will be returned; otherwise}\textquotesingle{}b\textquotesingle{}\`{} will be returned.\hypertarget{md_build_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md132}{}\doxysubsection{\texorpdfstring{Matching Multiple Arguments as a Whole}{Matching Multiple Arguments as a Whole}}\label{md_build_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md132}
...
says that {\ttfamily Blah} will be called with arguments {\ttfamily x}, {\ttfamily y}, and {\ttfamily z} where {\ttfamily x \texorpdfstring{$<$}{<} y \texorpdfstring{$<$}{<} z}. Note that in this example, it wasn\textquotesingle{}t necessary specify the positional matchers.
...
Note that if you want to pass the arguments to a predicate of your own (e.\+g. {\ttfamily .With(Args\texorpdfstring{$<$}{<}0, 1\texorpdfstring{$>$}{>}(Truly(\&My\+Predicate)))}), that predicate MUST be written to take a {\ttfamily std\+::tuple} as its argument; g\+Mock will pass the {\ttfamily n} selected arguments as {\itshape one} single tuple to the predicate.\hypertarget{md_build_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md133}{}\doxysubsection{\texorpdfstring{Using Matchers as Predicates}{Using Matchers as Predicates}}\label{md_build_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md133}
...
\end{DoxyCode}
\hypertarget{md_build_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md134}{}\doxysubsection{\texorpdfstring{Using Matchers in googletest Assertions}{Using Matchers in googletest Assertions}}\label{md_build_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md134}
See \href{reference/assertions.md\#EXPECT_THAT}{\texttt{ {\ttfamily EXPECT\+\_\+\+THAT}}} in the Assertions Reference.\hypertarget{md_build_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md135}{}\doxysubsection{\texorpdfstring{Using Predicates as Matchers}{Using Predicates as Matchers}}\label{md_build_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md135}
...
Note that the predicate function / functor doesn\textquotesingle{}t have to return {\ttfamily bool}. It works as long as the return value can be used as the condition in in statement {\ttfamily if (condition) ...}.\hypertarget{md_build_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md136}{}\doxysubsection{\texorpdfstring{Matching Arguments that Are Not Copyable}{Matching Arguments that Are Not Copyable}}\label{md_build_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md136}
...
Remember\+: if you do this, don\textquotesingle{}t change {\ttfamily bar} after the {\ttfamily EXPECT\+\_\+\+CALL()}, or the result is undefined.\hypertarget{md_build_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md137}{}\doxysubsection{\texorpdfstring{Validating a Member of an Object}{Validating a Member of an Object}}\label{md_build_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md137}
...
\end{DoxyCode}
\hypertarget{md_build_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md138}{}\doxysubsection{\texorpdfstring{Validating the Value Pointed to by a Pointer Argument}{Validating the Value Pointed to by a Pointer Argument}}\label{md_build_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md138}
...
What if you have a pointer to pointer? You guessed it -\/ you can use nested {\ttfamily Pointee()} to probe deeper inside the value. For example, {\ttfamily Pointee(Pointee(\+Lt(3)))} matches a pointer that points to a pointer that points to a number less than 3 (what a mouthful...).\hypertarget{md_build_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md139}{}\doxysubsection{\texorpdfstring{Testing a Certain Property of an Object}{Testing a Certain Property of an Object}}\label{md_build_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md139}
Sometimes you want to specify that an object argument has a certain property, but there is no existing matcher that does this. If you want good error messages, you should \doxysectlink{md_build_2__deps_2googletest-src_2docs_2gmock__cook__book_NewMatchers}{define a matcher}{2}. If you want to do it quick and dirty, you could get away with writing an ordinary function.
...
\end{DoxyCode}
\hypertarget{md_build_2__deps_2googletest-src_2docs_2gmock__cook__book_QuickNewActions}{}\doxysubsection{\texorpdfstring{Writing New Actions Quickly}{Writing New Actions Quickly}}\label{md_build_2__deps_2googletest-src_2docs_2gmock__cook__book_QuickNewActions}
...
\end{DoxyCode}
\hypertarget{md_build_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md173}{}\doxysubsubsection{\texorpdfstring{Legacy macro-\/based Actions}{Legacy macro-\/based Actions}}\label{md_build_2__deps_2googletest-src_2docs_2gmock__cook__book_autotoc_md173}
