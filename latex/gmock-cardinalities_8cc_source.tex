...
\DoxyCodeLine{00033\ \textcolor{comment}{//\ This\ file\ implements\ cardinalities.}}
\DoxyCodeLine{00034\ }
\DoxyCodeLine{00035\ \textcolor{preprocessor}{\#include\ "{}gmock/gmock-\/cardinalities.h"{}}}
\DoxyCodeLine{00036\ }
...
\DoxyCodeLine{00041\ \textcolor{preprocessor}{\#include\ "{}gmock/internal/gmock-\/internal-\/utils.h"{}}}
...
\DoxyCodeLine{00047\ }
\DoxyCodeLine{00048\ \textcolor{comment}{//\ Implements\ the\ Between(m,\ n)\ cardinality.}}
\DoxyCodeLine{00049\ \textcolor{keyword}{class\ }BetweenCardinalityImpl\ :\ \textcolor{keyword}{public}\ CardinalityInterface\ \{}
\DoxyCodeLine{00050\ \ \textcolor{keyword}{public}:}
\DoxyCodeLine{00051\ \ \ BetweenCardinalityImpl(\textcolor{keywordtype}{int}\ min,\ \textcolor{keywordtype}{int}\ max)}
\DoxyCodeLine{00052\ \ \ \ \ \ \ :\ min\_(min\ >=\ 0\ ?\ min\ :\ 0),}
\DoxyCodeLine{00053\ \ \ \ \ \ \ \ \ max\_(max\ >=\ min\_\ ?\ max\ :\ min\_)\ \{}
...
\DoxyCodeLine{00065\ \ \ \ \ \ \ \ \ \ <<\ \textcolor{stringliteral}{"{})\ must\ be\ >=\ the\ invocation\ lower\ bound\ ("{}}\ <<\ min}
\DoxyCodeLine{00066\ \ \ \ \ \ \ \ \ \ <<\ \textcolor{stringliteral}{"{})."{}};}
\DoxyCodeLine{00067\ \ \ \ \ \ \ internal::Expect(\textcolor{keyword}{false},\ \_\_FILE\_\_,\ \_\_LINE\_\_,\ ss.str());}
\DoxyCodeLine{00068\ \ \ \ \ \}}
\DoxyCodeLine{00069\ \ \ \}}
\DoxyCodeLine{00070\ }
\DoxyCodeLine{00071\ \ \ \textcolor{comment}{//\ Conservative\ estimate\ on\ the\ lower/upper\ bound\ of\ the\ number\ of}}
\DoxyCodeLine{00072\ \ \ \textcolor{comment}{//\ calls\ allowed.}}
\DoxyCodeLine{00073\ \ \ \textcolor{keywordtype}{int}\ ConservativeLowerBound()\textcolor{keyword}{\ const\ override\ }\{\ \textcolor{keywordflow}{return}\ min\_;\ \}}
\DoxyCodeLine{00074\ \ \ \textcolor{keywordtype}{int}\ ConservativeUpperBound()\textcolor{keyword}{\ const\ override\ }\{\ \textcolor{keywordflow}{return}\ max\_;\ \}}
\DoxyCodeLine{00075\ }
\DoxyCodeLine{00076\ \ \ \textcolor{keywordtype}{bool}\ IsSatisfiedByCallCount(\textcolor{keywordtype}{int}\ call\_count)\textcolor{keyword}{\ const\ override\ }\{}
\DoxyCodeLine{00077\ \ \ \ \ \textcolor{keywordflow}{return}\ min\_\ <=\ call\_count\ \&\&\ call\_count\ <=\ max\_;}
\DoxyCodeLine{00078\ \ \ \}}
\DoxyCodeLine{00079\ }
\DoxyCodeLine{00080\ \ \ \textcolor{keywordtype}{bool}\ IsSaturatedByCallCount(\textcolor{keywordtype}{int}\ call\_count)\textcolor{keyword}{\ const\ override\ }\{}
\DoxyCodeLine{00081\ \ \ \ \ \textcolor{keywordflow}{return}\ call\_count\ >=\ max\_;}
\DoxyCodeLine{00082\ \ \ \}}
\DoxyCodeLine{00083\ }
\DoxyCodeLine{00084\ \ \ \textcolor{keywordtype}{void}\ DescribeTo(::std::ostream*\ os)\ \textcolor{keyword}{const\ override};}
\DoxyCodeLine{00085\ }
\DoxyCodeLine{00086\ \ \textcolor{keyword}{private}:}
\DoxyCodeLine{00087\ \ \ \textcolor{keyword}{const}\ \textcolor{keywordtype}{int}\ min\_;}
\DoxyCodeLine{00088\ \ \ \textcolor{keyword}{const}\ \textcolor{keywordtype}{int}\ max\_;}
\DoxyCodeLine{00089\ }
\DoxyCodeLine{00090\ \ \ GTEST\_DISALLOW\_COPY\_AND\_ASSIGN\_(BetweenCardinalityImpl);}
\DoxyCodeLine{00091\ \};}
\DoxyCodeLine{00092\ }
