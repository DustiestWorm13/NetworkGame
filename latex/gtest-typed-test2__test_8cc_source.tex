...
\DoxyCodeLine{00035\ }
\DoxyCodeLine{00036\ \textcolor{comment}{//\ Tests\ that\ the\ same\ type-\/parameterized\ test\ case\ can\ be}}
\DoxyCodeLine{00037\ \textcolor{comment}{//\ instantiated\ in\ different\ translation\ units\ linked\ together.}}
\DoxyCodeLine{00038\ \textcolor{comment}{//\ (ContainerTest\ is\ also\ instantiated\ in\ gtest-\/typed-\/test\_test.cc.)}}
\DoxyCodeLine{00039\ INSTANTIATE\_TYPED\_TEST\_SUITE\_P(Vector,\ \mbox{\hyperlink{class_container_test}{ContainerTest}},}
\DoxyCodeLine{00040\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \mbox{\hyperlink{structtesting_1_1internal_1_1_proxy_type_list}{testing::Types}}<std::vector<int>\ >);}
