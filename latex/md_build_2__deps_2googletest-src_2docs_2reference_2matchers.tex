...
\{\+: .callout .note\} {\bfseries{Note\+:}} Although equality matching via {\ttfamily EXPECT\+\_\+\+THAT(actual\+\_\+value, expected\+\_\+value)} is supported, prefer to make the comparison explicit via {\ttfamily EXPECT\+\_\+\+THAT(actual\+\_\+value, Eq(expected\+\_\+value))} or {\ttfamily EXPECT\+\_\+\+EQ(actual\+\_\+value, expected\+\_\+value)}.
...
{\ttfamily cpp using \+::std\+::get; MATCHER(Foo\+Eq, "{}"{}) \{ return std\+::get\texorpdfstring{$<$}{<}0\texorpdfstring{$>$}{>}(arg).Equals(std\+::get\texorpdfstring{$<$}{<}1\texorpdfstring{$>$}{>}(arg)); \} ... EXPECT\+\_\+\+THAT(actual\+\_\+foos, Pointwise(\+Foo\+Eq(), expected\+\_\+foos)); }
