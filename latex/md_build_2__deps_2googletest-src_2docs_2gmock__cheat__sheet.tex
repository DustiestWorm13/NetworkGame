...
\label{md_build_2__deps_2googletest-src_2docs_2gmock__cheat__sheet_autotoc_md110}%
\Hypertarget{md_build_2__deps_2googletest-src_2docs_2gmock__cheat__sheet_autotoc_md110}%
 \hypertarget{md_build_2__deps_2googletest-src_2docs_2gmock__cheat__sheet_autotoc_md111}{}\doxysection{\texorpdfstring{Defining a Mock Class}{Defining a Mock Class}}\label{md_build_2__deps_2googletest-src_2docs_2gmock__cheat__sheet_autotoc_md111}
...
\end{DoxyCode}
\hypertarget{md_build_2__deps_2googletest-src_2docs_2gmock__cheat__sheet_autotoc_md112}{}\doxysubsection{\texorpdfstring{Specifying Calling Conventions for Mock Functions}{Specifying Calling Conventions for Mock Functions}}\label{md_build_2__deps_2googletest-src_2docs_2gmock__cheat__sheet_autotoc_md112}
...
See the \href{reference/mocking.md\#EXPECT_CALL.Times}{\texttt{ {\ttfamily Times} clause}} of {\ttfamily EXPECT\+\_\+\+CALL} in the Mocking Reference.\hypertarget{md_build_2__deps_2googletest-src_2docs_2gmock__cheat__sheet_autotoc_md113}{}\doxysection{\texorpdfstring{Expectation Order}{Expectation Order}}\label{md_build_2__deps_2googletest-src_2docs_2gmock__cheat__sheet_autotoc_md113}
By default, expectations can be matched in {\itshape any} order. If some or all expectations must be matched in a given order, you can use the \href{reference/mocking.md\#EXPECT_CALL.After}{\texttt{ {\ttfamily After} clause}} or \href{reference/mocking.md\#EXPECT_CALL.InSequence}{\texttt{ {\ttfamily In\+Sequence} clause}} of {\ttfamily EXPECT\+\_\+\+CALL}, or use an \href{reference/mocking.md\#InSequence}{\texttt{ {\ttfamily In\+Sequence} object}}.\hypertarget{md_build_2__deps_2googletest-src_2docs_2gmock__cheat__sheet_autotoc_md114}{}\doxysection{\texorpdfstring{Verifying and Resetting a Mock}{Verifying and Resetting a Mock}}\label{md_build_2__deps_2googletest-src_2docs_2gmock__cheat__sheet_autotoc_md114}
...
\end{DoxyCode}
\hypertarget{md_build_2__deps_2googletest-src_2docs_2gmock__cheat__sheet_autotoc_md115}{}\doxysection{\texorpdfstring{Mock Classes}{Mock Classes}}\label{md_build_2__deps_2googletest-src_2docs_2gmock__cheat__sheet_autotoc_md115}
...
See this \href{gmock_cook_book.md\#using-check-points}{\texttt{ recipe}} for one application of it.\hypertarget{md_build_2__deps_2googletest-src_2docs_2gmock__cheat__sheet_autotoc_md116}{}\doxysection{\texorpdfstring{Flags}{Flags}}\label{md_build_2__deps_2googletest-src_2docs_2gmock__cheat__sheet_autotoc_md116}
\tabulinesep=1mm
